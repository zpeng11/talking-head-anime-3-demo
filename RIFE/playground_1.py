...
export_name = './export/rife_x2/rife_384'
internal_size = 384
sharpen_factor = 1.0
...
pw = image_size
ph = image_size
timestep1 = torch.full([1, 1, ph, pw], 1.0/2.0, dtype=dtype, device=device)
...
class RIFEWrapped(nn.Module):
    def __init__(self, flownet, encoder):
        ...
        self.timestep_1 = torch.full([1, 1, internal_size, internal_size], 1.0/2.0, dtype=dtype, device=device)
